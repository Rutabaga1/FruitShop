    ...
    <li class="J_Addr J_MakePoint clearfix  J_DefaultAddr " data-point-url="">
        ...
        <div class="address-info">
            ...
            <label for="addrId_674944241" class="user-address">
                江苏省 中国矿业大学<s:property value='order.address' /> ( ${sessionScope.customerName} 收) 
            </label>
        </div>
    </li>
...
<tbody data-spm="3" class="J_Shop" data-tbcbid="0" data-outshoppingCarid="47285539868" data-isb2c="false" data-postMode="2" data-sellerid="1704508670">
  ...
  <%--  <s:iterator value="orders" var="order">  --%>
    <tr class="item" data-lineid="19614514619:31175333266:35612993875" data-pointRate="0">
        <td class="s-title">
            <a href="#" target="_blank" title="<s:property value='order.fruitName' />" class="J_MakePoint" data-point-url="">
                <img src="images/<s:property value='order.picture' />" class="itempic"><span class="title J_MakePoint" data-point-url=""><s:property value='order.fruitName' /></span></a>
            <div class="props">
                <span>天然有营养 </span>
        ...
        <td class="s-price">
            <span class='price '>
 <em class="style-normal-small-black J_ItemPrice"  ><s:property value='order.price' /></em>
  </span>
            <input type="hidden" name="costprice" value="<s:property value='order.price' />" class="J_CostPrice" />
        </td>
        <td class="s-amount" data-point-url="">
            <input type="hidden" class="J_Quantity" value="1" name="19614514619_31175333266_35612993875_quantity" /><s:property value='order.quantity' />
        </td>
        <td class="s-agio">
        ...
        <td class="s-total">
            <span class='price '>
 <em class="style-normal-bold-red J_ItemTotal "  ><s:property value='order.price' />*<s:property value='order.quantity' /></em>
  </span>
        ...
        <td colspan="5">
            <div class="shoppingCar-go" data-spm="4">
                <div class="J_AddressConfirm address-confirm">
                    <div class="kd-popup pop-back" style="margin-bottom: 20px;">
                        <div class="box">
                            <div class="bd">
                                <div class="point-in">
                                    <em class="t">实付款：</em> <span class='price g_price '>
 <span>&yen;</span><em class="style-large-bold-red" id="J_ActualFee"><s:property value='order.price*order.quantity' /></em>
                                    </span>
                                </div>
                                <ul>
...
<s:property value='order.address' />
                                    ...
                                    <li><em>收货人:</em><span id="J_AddrNameConfirm">${sessionScope.customerName}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="shoppingCar-go" data-spm="4">
                <div class="J_AddressConfirm address-confirm">
                    <div class="kd-popup pop-back" style="margin-bottom: 40px;">
                        ...
                        <a href="addOrder" id="J_Go" class=" btn-go" data-point-url="" tabindex="0" title="点击此按钮，提交订单。">提交订单<b class="dpl-button"></b></a>
                    </div>
                </div>
